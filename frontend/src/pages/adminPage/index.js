...
export const Index = () => {
  ...
  // removed unused isAdmin state (we redirect non-admins immediately)
  ...
  if (checkingAdminStatusLoader) {
    ...
    return (
      <>
        ...
        <div className="flex mx-[4%] justify-between items-start mt-4 md:mx-[4%] lg:mx-[2%] xl:mx-[4%] tablet:mx-[6%] ">
          <article className="w-[50%] tablet:w-[35%] lg:w-[30%] md:w-[30%] bg-[#ffffff] max-w-[264px] mb-6 flex-col flex gap-2">
            <div
            ...
            <div
              className="hidden flex-col rounded-md shadow-[0px_3px_8px_0px_rgba(0,0,0,0.2)] py-4 gap-4 z-[200] px-[10%] sticky top-0 left-0 right-0 -mb-[14.5rem] md:-mb-[11.5rem] bg-primaryColor text-white"
            ...
            >
              ...
              <Link to="category-Management">
                <li data-tabpath="Category management">Category management</li>
              </Link>
              <Link to="orders-Management">
                <li data-tabpath="Orders management">Orders management</li>
              </Link>
          ...
          <div
            className="text-center w-[100px] h-9 hover:opacity-100 bg-lighterPrimaryColor text-darkPrimaryColor cursor-pointer shadow-[0px_3px_8px_0px_rgba(0,0,0,0.1)] rounded-md flex items-center justify-center"

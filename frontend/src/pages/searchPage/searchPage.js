...
export const SearchPage = () => {
  ...
  useEffect(() => {
    // include prevPage and navigate in deps so linter is satisfied
    !prevPage && navigate("/");
  }, [prevPage, navigate]);
  ...
  }, [dispatch, sortingCriteria, allProductsData, searchValue, NoOfProductsPerPage, currentPageNo, location.pathname]);

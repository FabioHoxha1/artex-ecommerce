...
import { logout } from "../../features/authSlice/index"
...
export const ProfilePage = () => {
  ...
  const logoutBtnClick = async () => {
    try {
      ...
      // Dispatch clearCart action to clear cart and wishlist
      dispatch(clearCart())
  ...
  if (isTokenValidLoader) {
    ...
    return (
      <>
        ...
        <div className="flex mx-[4%] justify-between mt-4  md:mx-[4%] lg:mx-[2%] xl:mx-[4%] tablet:mx-[6%] ">
